...
DECLARE_MSG_NO_PARAMS(CMD_GET_CLOUD_BEGIN, SCmdGetCloudBegin)
DECLARE_MSG_NO_PARAMS(CMD_GET_CLOUD_NEXT, SCmdGetCloudNext)
DECLARE_MSG_NO_PARAMS(CMD_GET_CLOUD_END, SCmdGetCloudEnd)
